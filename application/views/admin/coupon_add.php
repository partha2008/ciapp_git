			...
			<div class="row">
				<div class="col-lg-12">						
					...
					<div class="alert alert-danger alert-dismissable">
						...
						<?php echo $this->session->userdata('couponadd_notification');?>
					</div>
					<?php } 
						$this->session->unset_userdata('has_error');
						$this->session->unset_userdata('couponadd_notification');
					?>
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="<?php echo base_url('admin/coupon/add_coupon');?>" method="POST" role="form" novalidate>
