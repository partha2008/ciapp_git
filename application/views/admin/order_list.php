										...
										if(count($order_list) > 0){ 
											...
											foreach($order_list AS $list) {
												...
												if(!in_array($list->orderid, $arr)){
													echo '<tr class="gradeA odd" role="row" style="text-align:right;"><td colspan="9"><a href="'.base_url('admin/order/resend_mail_to_user/'.$list->order_id).'" class="btn btn-primary">Send Email to User</a></td></tr>';
												}
												$arr[] = $list->orderid;
