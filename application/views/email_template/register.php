                        ...
                        <tr>
                            <td valign="top" bgcolor="#FFFFFF" style="border: 1px solid #dadada; padding: 30px 30px 20px">
                                <div style="font-family: Lucida Grande,Lucida Sans,Lucida Sans Unicode,Arial,Helvetica,Verdana,sans-serif; font-size: 14px; line-height: 1.5em; font-weight: normal; color: #222222">
                                    <?php echo $site_title;?>,
                                    <div style="padding: 15px 0px; font-size: 14px; color: #999999">You have registered successfully</div>
									...
									Here is your login details: <a href="<?php echo $site_url;?>#/login">Click here to login</a>
                                    <div style="padding: 10px 0px">                                        
                                                                    ...
                                                                    <div style="font-family: Lucida Grande,Lucida Sans,Lucida Sans Unicode,Arial,Helvetica,Verdana,sans-serif; font-size: 14px">
                                                                        <span style="color: #999999; font-size: 14px; font-weight:bold;">
																			<table class="tbl_msg_body_content" cellpadding="2" cellspacing="2" width="100%">
																				<tr>
																					<td style="color: #353535;width:30%;">Username</td>
																					<td style="color: #999999;width:70%;"><?php echo $user_name;?></td>
																				</tr>
																				<tr>
																					<td style="color: #353535;width:30%;">Email Address</td>
																					<td style="color: #999999;width:70%;"><?php echo $email_address;?></td>
																				</tr>
																				<tr>
																					<td style="vertical-align:top;color: #353535;width:30%;">Password</td>
																					<td style="color: #999999;width:70%;">Your given Password</td>
																				</tr>
																			</table>
																		</span>
																	</div>
										...
										<div style="font-family: Lucida Grande,Lucida Sans,Lucida Sans Unicode,Arial,Helvetica,Verdana,sans-serif; font-size: 14px; line-height: 2em; color: #C0392B; padding-top: 20px;text-align:center;font-weight:700;">Thank you for registration</div>
